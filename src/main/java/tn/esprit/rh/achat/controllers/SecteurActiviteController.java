...
public class SecteurActiviteController {
	...
	@ResponseBody
	public SecteurActivite addSecteurActivite(@RequestBody SecteurActiviteDTO saDTO) {
		SecteurActivite sa = new SecteurActivite(saDTO);
	...
	@ResponseBody
	public SecteurActivite modifySecteurActivite(@RequestBody SecteurActiviteDTO saDTO) {
		SecteurActivite sa = new SecteurActivite(saDTO);
